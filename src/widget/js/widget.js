...
export default class Widget {
  constructor(user, options) {
    ...
    ticketNew.on('click', () => {
      ...
      SendBirdDesk.Ticket.create(tempTicketTitle, user.nickname,"","","LOW",[], "ticket_bot_1", (ticket, err) => {
        if (err) throw err;
        this.spinner.detach();
    ...
    async function init() {
      try {
        ...
        await self.sendbird.connect(user.userId, "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1IjozMTU1MDUyNjEsInYiOjEsImUiOjE2OTU3MjgwMjZ9.A8w7ikfxOgotr8Y5qyTw1iZQ0sNggyDfJnvBFr7t-qE" );
      ...
      try {
        ...
        SendBirdDesk.authenticate(
          user.userId,
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1IjozMTU1MDUyNjEsInYiOjEsImUiOjE2OTU3MjgwMjZ9.A8w7ikfxOgotr8Y5qyTw1iZQ0sNggyDfJnvBFr7t-qE",
          () => {
            ...
            channelHandler.onChannelChanged = channel => {
              ...
              try {
                Dialog.talkingTo = JSON.parse(channel.data).talk_to;
                console.log(Dialog.talkingTo);
              } catch(e) {
                console.log(e);
              }
